...
Set-KnownFolderPath -KnownFolder 'Desktop' -Path '~\Box\Desktop'
Set-KnownFolderPath -KnownFolder 'Documents' -Path '~\Box\Documents'

Get-ChildItem -Path '~\Desktop\*' -Recurse | Move-Item -Destination '~\Box\Desktop'
Get-ChildItem -Path '~\Documents\*' -Recurse | Move-Item -Destination '~\Box\Documents'